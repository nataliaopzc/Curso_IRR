# Metodología 
Ejercio para calcular la capacidad de reproducción y nivel de recuperación del recurso. 
...
Curvas de equilibrio para tres casos de valores del parámetro p (densodependencia):
